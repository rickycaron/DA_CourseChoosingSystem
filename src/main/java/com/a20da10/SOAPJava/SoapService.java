 ...
 * 
 */
@WebServiceClient(name = "SoapService", targetNamespace = "http://SOAP.a20da10.com/", wsdlLocation = "http://laptop-zjl:8080/DistributedApplication-1.0-SNAPSHOT/SoapService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICE_QNAME = new QName("http://SOAP.a20da10.com/", "SoapService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://laptop-zjl:8080/DistributedApplication-1.0-SNAPSHOT/SoapService?wsdl");
    ...
    public Soap getSoapPort() {
        return super.getPort(new QName("http://SOAP.a20da10.com/", "SoapPort"), Soap.class);
    }
    ...
    public Soap getSoapPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://SOAP.a20da10.com/", "SoapPort"), Soap.class, features);
    }
